...
class AdminController extends Controller
{
    public function dashboard()
    {
        ...
        $pie_data = DB::table('sale_details as sd')
            ...
            ->selectRaw('p.nama_produk, SUM(sd.product_qty) as total_sold')
            ->groupBy('p.nama_produk')
            ->get();

        $product_name = $pie_data->pluck('nama_produk');
        ...
        return view('admin-page.dashboard', compact('dates', 'totals', 'product_name', 'product_qty', 'today_sale', 'profittoday', 'profitweek', 'profitmonth', 'profityear'));
